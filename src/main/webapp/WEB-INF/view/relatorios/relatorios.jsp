...
<vetweb:layout title="Relatórios">
	<jsp:attribute name="jsFooter">
        <script type="text/javascript"
			src="<c:url value="/resources/js/app/relatorios.js"></c:url>"></script>
    </jsp:attribute>
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a
							href="<c:url value="/clientes/listar"></c:url>">Relatórios</a></li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="table-responsive m-t-40">
											...
											cellspacing="0" width="100%">
												...
												id="form">
                                                                      ...
                                                                      <tr>
                                                                          <th><spring:message
															code="relatoriosDisponiveis" />: </th>
                                                                        <td>
                                                                            <select
														name="tipoRelatorio" id="tipoRelatorio">
                                                                                <option
																value="Ocorrencia"><spring:message
																	code="ocorrenciasPorTipo" /></option>
                                                                                <option
																value="Clientes_por_ano"><spring:message
																	code="clientesPorAno" /></option>
                                                                            </select>
                                                                          </td>
                                                                      </tr>
