                ...
                <div class="card">
                    <div class="card-body p-b-0">
                        ...
                        <ul class="nav nav-tabs customtab" role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#atendimento" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Atendimentos</span></a> </li>

                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#vacina" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Vacinas</span></a> </li>
                        </ul>
                        <!-- Tab panes -->


                        <div class="tab-content">
                            <div class="tab-pane active " id="atendimento" role="tabpanel">
                                <div class="p-20 ">
                                    <table class="table table-responsive" id="detalhesProprietario">
                                        <table id="atendimento" class="table table-responsive">
                                                                        <thead>
                                                                            <tr>
                            ...
                            <div class="tab-pane  p-20" id="vacina" role="tabpanel">
                                <table id="atendimento" class="table table-responsive">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Nome</th>
